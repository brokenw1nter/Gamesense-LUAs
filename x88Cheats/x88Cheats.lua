--[[
	...
	Version: 2.0
	Note: I'm actually dumb and can not for the life of me figure out how to check for the things listed in "Needs Fix"
	...
	Needs Fix: In Lobby because 'paint' isn't called unless you're in a game. If there's another callback let me know please.
	...
	Credits: kopretinka (Gamesense Forums) - Spectators List
]]--
